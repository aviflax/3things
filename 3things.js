...
(function() {
  var archive_thingset, backup_warning_maybe, clear_and_render_prior, clear_prior_things, current_iso_date, d, get_checkbox, get_current_thingset_state, get_text_input, get_thing_state, get_today_thingset, handle_checkbox_change, handle_export_click, handle_import_click, input_ids, interval_check_whether_day_changed, is_current_day, load_state, prior_thing_to_li, render_current_state, render_current_thing, render_prior_things, render_prior_thingset, reset_thing, reset_ui, save_current_state, to_array, toggle_import_button, update_and_save, update_input_render_state, update_today_list_date;
