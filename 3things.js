...
(function() {
  ...
  d.addEventListener('DOMContentLoaded', function() {
    var current_state, input, textarea, thing_textareas, _i, _j, _len, _len1, _ref;
    ...
    for (_i = 0, _len = thing_textareas.length; _i < _len; _i++) {
      textarea = thing_textareas[_i];
      textarea.addEventListener('input', update_and_save);
    }
