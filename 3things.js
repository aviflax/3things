...
(function() {
  var archive_thingset, clear_and_render_prior, clear_prior_things, current_iso_date, d, export_prior_things, get_checkbox, get_current_thingset_state, get_text_input, get_thing_state, get_today_thingset, handle_checkbox_change, input_ids, is_current_day, load_state, prior_thing_to_li, render_current_state, render_prior_things, render_prior_thingset, render_thing, reset_thing, reset_ui, save_current_state, to_array, update_and_save, update_input_render_state, update_today_list_date;
  ...
  clear_prior_things = function() {
    ...
    _ref = to_array(details.getElementsByTagName('details')).slice(0, -2);
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      child = _ref[_i];
