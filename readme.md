Three Things is a client-side Web application inspired by Jeff Atwood’s post [Three Things](http://blog.codinghorror.com/three-things/). For more, see [about.html](about.html).
